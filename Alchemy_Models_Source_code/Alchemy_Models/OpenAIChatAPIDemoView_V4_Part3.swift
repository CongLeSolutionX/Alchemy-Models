...
//                var buffer = Data()
//                // Use the raw byte stream here if reading error details
//                for try await byte in inputStream.prefix(4096) {
//                    buffer.append(byte)
//                }
//                if let errStr = String(data: buffer, encoding: .utf8) {
//                    errorMessage = "API Error (\(httpResp.statusCode)): \(errStr)" // Include status code
//                } else {
...
//            var assistantReply = ""
//            // *** FIX IS HERE ***
//            // inputStream.lines yields Strings directly
//            for try await line in inputStream.lines {
//                // line is already a String, no decoding needed here
//                // Process the line
//                guard line.hasPrefix("data: ") else { continue }
//                let jsonPart = line.replacingOccurrences(of: "data: ", with: "")
//                if jsonPart == "[DONE]" { break }
//                // Get Data from the String jsonPart
//                guard let d = jsonPart.data(using: .utf8) else { continue } // This should work now
...
//            
//            // Finalize message
//            if !assistantReply.isEmpty { // Only add if we got content
...
//    }
//
//    // Rest of the code (Models, speakText, View, etc.) remains the same...
//    // Make sure to include the speakText function, Models, View structure
//    // from the previous full code example.
//    
