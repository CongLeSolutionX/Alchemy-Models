...
//
////
////  OpenAIChatAPIDemoView_V6_VietnameseSpeech.swift
////  Alchemy_Models
////  AIChatVoiceDemo
////  Created by Cong Le on 4/20/25.
////  Modified for Vietnamese ASR configuration.
////
//
//import SwiftUI
//import Speech
...
//            completion(.success(replies.randomElement() ?? "Xin hãy thử lại."))
//        }
//    }
//}
//
...
//                let text = obj.choices.first?.message.content ?? "Không có phản hồi."
...
//            errorMessage = "Trình nhận ra giọng nói hiện không khả dụng."
//            isRecording = false
//            return
//        }
//        
...
//            .system("Bạn là trợ lý thông minh, trả lời ngắn gọn và rõ ràng bằng tiếng Việt."),
//            .user("Xin chào!"),
//            .assistant("Chào bạn! Mình có thể giúp gì?")
//        ])
//    ]
//    @Published var currentConversation: Conversation =
//    Conversation(messages: [.system("Bạn là trợ lý thông minh, trả lời ngắn gọn và rõ ràng bằng tiếng Việt.")])
//    
//    // UI state
//    @Published var input: String = ""
//    @Published var isLoading = false
//    @Published var errorMessage: String?
//    @Published var systemPrompt: String = "Bạn là trợ lý thông minh, trả lời ngắn gọn và rõ ràng bằng tiếng Việt."
...
//                    self.errorMessage = "Lỗi: \(err.localizedDescription)"
//                }
//            }
//        }
//    }
...
//    }
//    
//    // Voice command parsing remains in English for demo…
...
//        NavigationStack {
//            Form {
//                Section("Tính năng") { // New section for features
//                    Toggle("Bật phản hồi âm thanh (TTS)", isOn: $ttsEnabled) // <-- Toggle for TTS
//                }
//                
...
//// MARK: - MAIN VIEW
//
//struct OpenAIChatVoiceDemoVietnamese: View {
...
//                speech.requestAuthorization { granted in
//                    if !granted {
//                        // already sets errorMessage in Vietnamese
//                    }
//                }
...
//    }
//    
//    // ... header, chatScrollView, toolbar, ChatInputBar, MessageBubble,
//    //     SettingsSheet, ProfileSheet, Previews remain identical to previous version,
//    // MARK: - MESSAGE BUBBLE
//    
