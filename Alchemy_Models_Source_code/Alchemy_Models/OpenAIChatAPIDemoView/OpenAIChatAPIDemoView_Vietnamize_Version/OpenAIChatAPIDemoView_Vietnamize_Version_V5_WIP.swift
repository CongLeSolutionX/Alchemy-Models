////
////  OpenAIChatAPIDemoView_Vietnamize_Version_V5_WIP.swift
////  Alchemy_Models
////
...
////
//// ChatDemoView.swift
//// Single‐file SwiftUI Chat Demo with dynamic TTS voices
////
...
//    @Binding var ttsVoiceID: String
//
//    // dynamic list of all installed TTS voices
...
//                    }
//                    Picker("Giọng nói", selection: $ttsVoiceID) {
//                        ForEach(allVoices, id: \.identifier) { v in
...
//                ) { b,m in store.setBackend(b, mock: m) }
//            }
