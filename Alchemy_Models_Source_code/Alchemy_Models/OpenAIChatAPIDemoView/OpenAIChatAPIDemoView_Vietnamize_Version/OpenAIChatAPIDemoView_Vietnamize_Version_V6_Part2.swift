...
//    // Keep your @AppStorage variables as they are...
//    @AppStorage("openai_api_key") private var apiKey = ""
...
//    let models = ["gpt-4o","gpt-4","gpt-3.5-turbo"]
//    
//    // --- CHANGE 1: Fix onUpdate type ---
//    // Change from a tuple to a closure type
//    var onUpdate: (ChatBackend, BackendType) -> Void  // Removed the tuple parentheses, added -> Void
//    
//    // --- CHANGE 2: Add a Binding for ttsEnabled ---
//    @Binding var ttsEnabled_Binding: Bool // Add this binding
//    
...
//                    // --- CHANGE 3: Use the new binding for the Toggle ---
//                    Toggle("Bật TTS", isOn: $ttsEnabled_Binding) // Use the binding passed from parent
//                    // Delete the commented out line below this Toggle in your original code
//                }
//            }
...
//            backend = MockChatBackend()
//        case .openAI:
//            // Ensure apiKey and modelName are used correctly from @AppStorage
//            let key = apiKey.trimmingCharacters(in: .whitespaces)
//            if !key.isEmpty {
//                backend = RealOpenAIBackend(
//                    apiKey: key,
...
//                )
//            } else {
//                // Fallback if API key is missing, maybe keep Mock or handle error?
//                print("Warning: OpenAI API Key is missing. Falling back to Mock backend.")
//                backend = MockChatBackend()
//                // Optionally, you could prevent switching to OpenAI if key is missing,
//                // or revert backendTypeRaw here.
//            }
//            
//        case .coreML:
//            backend = CoreMLChatBackend(modelName: coreMLModelName)
//        }
//        // This call is now correct because onUpdate is a closure
...
//            // --- CHANGE 4: Update how SettingsSheet is initialized ---
//            SettingsSheet(
//                onUpdate: { backend, type in // Pass the closure
//                    store.setBackend(backend, type: type)
//                },
//                ttsEnabled_Binding: $store.ttsEnabled // Pass the binding
//            )
